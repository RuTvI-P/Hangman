...
def hangMan():
  ...
  while guesses < 6:
        ...
        # If the user enters more than one letter at a time
  		if len(guess) > 1:
  				print("Enter one letter at time.")
  		elif guess == "":
  				print("Please enter something.")
        # If the user guess the same letter again.
  		elif guess in guess_list:
  				print("You already guessed that letter! Here is what you've guessed so far:")
  				print ' '.join(guess_list)
        # The guessed letter gets appended to the guess_list 
  		else:
